...
func HTTPSRedirect() vodka.MiddlewareFunc {
...
// See `HTTPSRedirect()`.
func HTTPSRedirectWithConfig(config RedirectConfig) vodka.MiddlewareFunc {
	// Defaults
...
func HTTPSWWWRedirect() vodka.MiddlewareFunc {
...
func HTTPSWWWRedirectWithConfig(config RedirectConfig) vodka.MiddlewareFunc {
	// Defaults
	if config.Skipper == nil {
		config.Skipper = DefaultTrailingSlashConfig.Skipper
	}
...
func NonWWWRedirect() vodka.MiddlewareFunc {
...
// See `NonWWWRedirect()`.
func NonWWWRedirectWithConfig(config RedirectConfig) vodka.MiddlewareFunc {
	if config.Skipper == nil {
		config.Skipper = DefaultTrailingSlashConfig.Skipper
	}
	if config.Code == 0 {
